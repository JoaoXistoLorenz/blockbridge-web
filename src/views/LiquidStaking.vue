    ...
    <el-main ref="main" class="main">
      ...
      <div class="titulo-principal">
        ...
        <div class="titulo-secundario">
          <font-awesome-icon icon="money-check-dollar" class="color-principal"/>
          Encontre as principais plataforma de Stake Liquido do mercado!
        </div>
      </div>
...
<script lang="ts">
  ...
  export default class LiquidStaking extends Vue {
    public loading = true;
